...
export default class Crud extends React.Component {
  constructor(props) {
    ...
    this.state = {
      filterStr: '',
      persons: [
        { id: uuidv4(), name: 'Emil', surname: 'Hans' },
        { id: uuidv4(), name: 'Mustermann', surname: 'Max' },
        { id: uuidv4(), name: 'Tisch', surname: 'Roman' }
      ],
    ...
    return (
      <div id="Crud" className="taskBody">
        <PersonFilter
          ...
          handleFilterStrChange={this.handleFilterStrChange}
        />
