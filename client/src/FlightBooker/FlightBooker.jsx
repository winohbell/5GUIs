...
export default class FlightBooker extends React.Component {
  ...
  startValid() {
    return this.isValidDate(this.state.startDate) ? '' : 'red';
  }
  endValid() {
    return !this.endDataDisable() && !this.isValidDate(this.state.endDate) ? 'red' : '';
  }
    ...
    return (
      <div id="FlightBooker" className="taskBody">
        ...
        <input
          ...
          style={{ background: this.startValid.call(this) }}
        />
        <input
          ...
          disabled={this.endDataDisable.call(this)}
          style={{ background: this.endValid.call(this) }}
        />
        <button onClick={this.handleBook} disabled={this.bookDisable.call(this)}>
          Book
        </button>
      </div>
    );
